        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-800 py-4 bg-gray-900">
            <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-2">
                  {navLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className={`flex items-center gap-2 hover:text-blue-400 transition px-2 py-2 rounded-md hover:bg-gray-800/50 ${
                        isActive(link.href) ? "text-blue-400 bg-gray-800/50" : "text-gray-300"
                      }`}
              ...
              <div className="px-2 border-t border-gray-700 pt-4">
                  ...
                  <div className="border-t border-gray-700 pt-4 mt-4">
                    <div className="px-2">
                      ...
                      <div className="space-y-1">
                        <Link
                          href="/cursor-rules/my-rules"
                          className="flex items-center gap-3 text-gray-300 hover:text-blue-400 transition px-2 py-2 rounded-md hover:bg-gray-800/50"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
                        ...
                        <Link
                          href="/cursor-rules/create"
                          className="flex items-center gap-3 text-gray-300 hover:text-green-400 transition px-2 py-2 rounded-md hover:bg-gray-800/50"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
                        ...
                        {isAdmin && (
                          <>
                            ...
                            <Link
                              href="/admin/dashboard"
                              className="flex items-center gap-3 text-gray-300 hover:text-purple-400 transition px-2 py-2 rounded-md hover:bg-gray-800/50"
                              onClick={() => setIsMobileMenuOpen(false)}
                            >
                        ...
                        <button
                          ...
                          className="flex items-center gap-3 text-gray-300 hover:text-red-400 transition px-2 py-2 rounded-md hover:bg-gray-800/50 w-full text-left"
                        >
                          <FiLogOut className="w-4 h-4" />
                          <span>Sign Out</span>
                        </button>
                  ...
                  <div className="border-t border-gray-700 pt-4 mt-4">
                    <div className="px-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Link
                          href="/auth/signup"
                          className="flex items-center gap-3 bg-blue-500 text-white px-2 py-2 rounded-md hover:bg-blue-600 transition"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
                          <FiUser className="w-4 h-4" />
                          <span>Sign Up</span>
